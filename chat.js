...
window.zammadChatTemplates["chat"] = function(__obj) {
  ...
  (function() {
    (function() {
      ...
      __out.push(this.T('Compose your messageâ€¦'));
...
window.zammadChatTemplates["waiting_list_timeout"] = function(__obj) {
  ...
  (function() {
    (function() {
      ...
      __out.push(this.T('Desculpe, está levando mais tempo que o esperado para conseguir um atendimento. Tente novamente mais tarde ou envie-nos um e-mail. Obrigado!'));
...
window.zammadChatTemplates["waiting"] = function(__obj) {
  ...
  (function() {
    (function() {
      ...
      __out.push(this.T('Todos os atendentes estão ocupados.'));
...
(function($, window) {
  ...
  ZammadChat = (function(superClass) {
    ...
    ZammadChat.prototype.translations = {
      'cs': {
        '<strong>Chat</strong> with us!': '<strong>Chatujte</strong> s nÃ¡mi!',
        'All colleagues are busy.': 'VÅ¡ichni kolegovÃ© jsou vytÃ­Å¾eni.',
        'Chat closed by %s': '%s ukonÄil konverzaci',
        'Compose your messageâ€¦': 'NapiÅ¡te svou zprÃ¡vuâ€¦',
        'Connecting': 'PÅ™ipojovÃ¡nÃ­',
        'Connection lost': 'PÅ™ipojenÃ­ ztraceno',
        'Connection re-established': 'PÅ™ipojenÃ­ obnoveno',
        'Offline': 'Offline',
        'Online': 'Online',
        'Scroll down to see new messages': 'Srolujte dolÅ¯ pro zobrazenÃ­ novÃ½ch zprÃ¡v',
        'Send': 'Odeslat',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'JelikoÅ¾ jste nereagovali v poslednÃ­ch %s minutÃ¡ch, vaÅ¡e konverzace byla uzavÅ™ena.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'JelikoÅ¾ jste nereagovali v poslednÃ­ch %s minutÃ¡ch, vaÅ¡e konverzace s <strong>%s</strong> byla uzavÅ™ena.',
        'Start new conversation': 'ZahÃ¡jit novou konverzaci',
        'Today': 'Dnes',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'OmlouvÃ¡me se, Å¾e musÃ­te Äekat dÃ©le, neÅ¾ je vhodnÃ© pro zÃ­skÃ¡nÃ­ slotu. ProsÃ­m, zkuste to pozdÄ›ji, pÅ™Ã­padnÄ› nÃ¡m napiÅ¡te e-mail. DÄ›kujeme!',
        'You are on waiting list position <strong>%s</strong>.': 'Jste <strong>%s</strong>. v poÅ™adÃ­ na ÄekacÃ­ listinÄ›.'
      },
      'da': {
        ...
        'Compose your messageâ€¦': 'Skriv din beskedâ€¦',
        ...
        'You are on waiting list position <strong>%s</strong>.': 'Du er i kÃ¸ som nummer <strong>%s</strong>.'
      },
      'de': {
        '<strong>Chat</strong> with us!': '<strong>Chatte</strong> mit uns!',
        'All colleagues are busy.': 'Alle Kollegen sind beschÃ¤ftigt.',
        'Chat closed by %s': 'Chat von %s geschlossen',
        'Compose your messageâ€¦': 'Verfassen Sie Ihre Nachrichtâ€¦',
        'Connecting': 'Verbinde',
        ...
        'Today': 'Heute',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Entschuldigung, es dauert lÃ¤nger als erwartet einen freien Platz zu bekommen. Versuchen Sie es spÃ¤ter erneut oder senden Sie uns eine E-Mail. Vielen Dank!',
      ...
      'es': {
        ...
        'All colleagues are busy.': 'Todos los colegas estÃ¡n ocupados.',
        'Chat closed by %s': 'Chat cerrado por %s',
        'Compose your messageâ€¦': 'Escribe tu mensajeâ€¦',
        'Connecting': 'Conectando',
        'Connection lost': 'ConexiÃ³n perdida',
        'Connection re-established': 'ConexiÃ³n reestablecida',
        'Offline': 'Desconectado',
        'Online': 'En lÃ­nea',
        'Scroll down to see new messages': 'Desplace hacia abajo para ver nuevos mensajes',
        'Send': 'Enviar',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Debido a que usted no ha respondido en los Ãºltimos %s minutos, su conversaciÃ³n se ha cerrado.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Debido a que usted no ha respondido en los Ãºltimos %s minutos, su conversaciÃ³n con <strong>%s</strong> se ha cerrado.',
        'Start new conversation': 'Iniciar nueva conversaciÃ³n',
        'Today': 'Hoy',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Lo sentimos, estamos tardando mÃ¡s de lo esperado para asignar un agente. IntÃ©ntelo de nuevo mÃ¡s tarde o envÃ­enos un correo electrÃ³nico. Â¡Gracias!',
        'You are on waiting list position <strong>%s</strong>.': 'Usted estÃ¡ en la posiciÃ³n <strong>%s</strong> de la lista de espera.'
      },
      'fr': {
        '<strong>Chat</strong> with us!': '<strong>Chattez</strong> avec nous !',
        'All colleagues are busy.': 'Tous les agents sont occupÃ©s.',
        'Chat closed by %s': 'Chat fermÃ© par %s',
        'Compose your messageâ€¦': 'Ã‰crivez votre messageâ€¦',
        'Connecting': 'Connexion',
        'Connection lost': 'Connexion perdue',
        'Connection re-established': 'Connexion rÃ©-Ã©tablie',
        'Offline': 'Hors-ligne',
        'Online': 'En ligne',
        'Scroll down to see new messages': 'DÃ©filer vers le bas pour voir les nouveaux messages',
        'Send': 'Envoyer',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Sans rÃ©ponse de votre part depuis %s minutes, votre conservation a Ã©tÃ© fermÃ©e.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Sans rÃ©ponse de votre part depuis %s minutes, votre conversation avec <strong>%s</strong> a Ã©tÃ© fermÃ©e.',
        'Start new conversation': 'DÃ©marrer une nouvelle conversation',
        'Today': 'Aujourd\'hui',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Nous sommes dÃ©solÃ©s, trouver un agent disponible prend plus de temps que prÃ©vu. RÃ©essayez plus tard ou envoyez-nous un mail. Merci !',
        'You are on waiting list position <strong>%s</strong>.': 'Vous Ãªtes actuellement en position <strong>%s</strong> dans la file d\'attente.'
      },
      'hr': {
        '<strong>Chat</strong> with us!': '<strong>ÄŒavrljajte</strong> sa nama!',
        'All colleagues are busy.': 'Svi agenti su zauzeti.',
        'Chat closed by %s': '%s zatvara chat',
        'Compose your messageâ€¦': 'Sastavite porukuâ€¦',
        ...
        'Send': 'PoÅ¡alji',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'BuduÄ‡i da niste odgovorili u posljednjih %s minuta, VaÅ¡ je razgovor zatvoren.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'BuduÄ‡i da niste odgovorili u posljednjih %s minuta, VaÅ¡ je razgovor s <strong>%</strong>s zatvoren.',
        'Start new conversation': 'ZapoÄni novi razgovor',
        'Today': 'Danas',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Oprostite, traje duÅ¾e nego inaÄe za dobiti slobodan termin. Molimo, pokuÅ¡ajte ponovno kasnije ili nam poÅ¡aljite e-mail. Hvala!',
        'You are on waiting list position <strong>%s</strong>.': 'Nalazite se u redu Äekanja na poziciji <strong>%s</strong>.'
      },
      'hu': {
        '<strong>Chat</strong> with us!': '<strong>Csevegjen</strong> velÃ¼nk!',
        'All colleagues are busy.': 'Minden munkatÃ¡rsunk foglalt.',
        'Chat closed by %s': 'A csevegÃ©s %s Ã¡ltal lezÃ¡rva',
        'Compose your messageâ€¦': 'Fogalmazza meg Ã¼zenetÃ©tâ€¦',
        'Connecting': 'CsatlakozÃ¡s',
        'Connection lost': 'A kapcsolat megszakadt',
        'Connection re-established': 'A kapcsolat helyreÃ¡llt',
        'Offline': 'Offline',
        'Online': 'Online',
        'Scroll down to see new messages': 'GÃ¶rgessen lefelÃ© az Ãºj Ã¼zenetek megtekintÃ©sÃ©hez',
        'Send': 'KÃ¼ldÃ©s',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Mivel az elmÃºlt %s percben nem vÃ¡laszolt, a beszÃ©lgetÃ©se lezÃ¡rÃ¡sra kerÃ¼lt.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Mivel az elmÃºlt %s percben nem vÃ¡laszolt, <strong>%s</strong> munkatÃ¡rsunkkal folytatott beszÃ©lgetÃ©sÃ©t lezÃ¡rtuk.',
        'Start new conversation': 'Ãšj beszÃ©lgetÃ©s indÃ­tÃ¡sa',
        'Today': 'Ma',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'SajnÃ¡ljuk, hogy a vÃ¡rtnÃ¡l hosszabb ideig tart a helyfoglalÃ¡s. KÃ©rjÃ¼k, prÃ³bÃ¡lja meg kÃ©sÅ‘bb Ãºjra, vagy kÃ¼ldjÃ¶n nekÃ¼nk egy e-mailt. KÃ¶szÃ¶njÃ¼k!',
        'You are on waiting list position <strong>%s</strong>.': 'Ã–n a vÃ¡rÃ³listÃ¡n a <strong>%s</strong> helyen szerepel.'
      },
      'it': {
        ...
        'Compose your messageâ€¦': 'Scrivi il tuo messaggioâ€¦',
        ...
        'Send': 'Invia',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Dato che non hai risposto negli ultimi %s minuti, la conversazione Ã¨ stata chiusa.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Dato che non hai risposto negli ultimi %s minuti, la conversazione con <strong>%s</strong> Ã¨ stata chiusa.',
        'Start new conversation': 'Avvia una nuova chat',
        'Today': 'Oggi',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Siamo spiacenti, ci vuole piÃ¹ tempo del previsto per ottenere uno spazio libero. Riprova piÃ¹ tardi o inviaci un\'e-mail. Grazie!',
        'You are on waiting list position <strong>%s</strong>.': 'Sei alla posizione <strong>%s</strong> della lista di attesa.'
      },
      'lt': {
        '<strong>Chat</strong> with us!': '<strong>KalbÄ—kitÄ—s</strong> su mumis!',
        'All colleagues are busy.': 'Visi kolegos uÅ¾imti.',
        'Chat closed by %s': '%s uÅ¾darÄ— pokalbÄ¯',
        'Compose your messageâ€¦': 'RaÅ¡ykite Å¾inutÄ™â€¦',
        'Connecting': 'Jungiamasi',
        'Connection lost': 'Dingo ryÅ¡ys',
        'Connection re-established': 'RyÅ¡ys atnaujintas',
        'Offline': 'AtsijungÄ™s',
        'Online': 'PrisijungÄ™s',
        'Scroll down to see new messages': 'Naujos Å¾inutÄ—s Å¾emiau',
        'Send': 'SiÅ³sti',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'JÅ«sÅ³ pokalbis buvo uÅ¾darytas, nes nieko neatsakÄ—te per %s minuÄiÅ³.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'JÅ«sÅ³ pokalbis su <strong>%s</strong> buvo uÅ¾darytas, nes nieko neatsakÄ—te per %s minuÄiÅ³.',
        'Start new conversation': 'PradÄ—ti naujÄ… pokalbÄ¯',
        'Today': 'Å iandien',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'AtsipraÅ¡ome, kad tenka laukti atskymo. Bandykite vÄ—liau arba raÅ¡ykite el. paÅ¡tu. AÄiÅ«!',
        'You are on waiting list position <strong>%s</strong>.': 'Esate <strong>%s</strong> eilÄ—je.'
      },
      'nl': {
        ...
        'Compose your messageâ€¦': 'Stel je bericht opâ€¦',
      ...
      'pl': {
        ...
        'All colleagues are busy.': 'Wszyscy agenci sÄ… zajÄ™ci.',
        'Chat closed by %s': 'Chat zamkniÄ™ty przez %s',
        'Compose your messageâ€¦': 'Skomponuj swojÄ… wiadomoÅ›Ä‡â€¦',
        'Connecting': 'ÅÄ…czenie',
        'Connection lost': 'Utracono poÅ‚Ä…czenie',
        'Connection re-established': 'Ponowne nawiÄ…zanie poÅ‚Ä…czenia',
        'Offline': 'Offline',
        'Online': 'Online',
        'Scroll down to see new messages': 'Skroluj w dÃ³Å‚, aby zobaczyÄ‡ wiadomoÅ›ci',
        'Send': 'WyÅ›lij',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'PoniewaÅ¼ nie odpowiedziaÅ‚eÅ› w ciÄ…gu ostatnich %s minut, Twoja rozmowa zostaÅ‚a zamkniÄ™ta.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'PoniewaÅ¼ nie odpowiedziaÅ‚eÅ› w ciÄ…gu ostatnich %s minut, Twoja rozmowa z <strong>%s</strong> zostaÅ‚a zamkniÄ™ta.',
        'Start new conversation': 'Rozpocznij nowÄ… rozmowÄ™',
        'Today': 'Dzisiaj',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Przepraszamy, znalezienie wolnego konsultanta zajmuje wiÄ™cej czasu niÅ¼ oczekiwano. SprÃ³buj ponownie pÃ³Åºniej lub wyÅ›lij nam e-mail. DziÄ™kujemy!',
        'You are on waiting list position <strong>%s</strong>.': 'JesteÅ› na pozycji listy oczekujÄ…cych <strong>%s</strong>.'
      },
      'pt-br': {
        '<strong>Chat</strong> with us!': '<strong>Converse</strong> conosco!',
        'All colleagues are busy.': 'Nossos atendentes estÃ£o ocupados.',
        'Chat closed by %s': 'Chat encerrado por %s',
        'Compose your messageâ€¦': 'Escreva sua mensagemâ€¦',
        'Connecting': 'Conectando',
        'Connection lost': 'ConexÃ£o perdida',
        'Connection re-established': 'ConexÃ£o restabelecida',
        'Offline': 'Desconectado',
        'Online': 'Online',
        'Scroll down to see new messages': 'Rolar para baixo para ver novas mensagems',
        'Send': 'Enviar',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Como vocÃª nÃ£o respondeu nos Ãºltimos %s minutos, sua conversa foi encerrada.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Como vocÃª nÃ£o respondeu nos Ãºltimos %s minutos, sua conversa com <strong>%s</strong> foi encerrada.',
        'Start new conversation': 'Iniciar uma nova conversa',
        'Today': 'Hoje',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Lamentamos, estÃ¡ demorando mais do que o esperado para conseguir uma vaga. Tente novamente mais tarde ou envie-nos um e-mail. Obrigado!',
        'You are on waiting list position <strong>%s</strong>.': 'VocÃª estÃ¡ na posiÃ§Ã£o <strong>%s</strong> da lista de espera.'
      },
      'ro': {
        '<strong>Chat</strong> with us!': '<strong>ComunicÄƒ</strong> cu noi!',
        'All colleagues are busy.': 'ToÈ›i colegii sunt ocupaÈ›i momentan.',
        'Chat closed by %s': 'Chat Ã®nchis de cÄƒtre %s',
        'Compose your messageâ€¦': 'Compune-È›i mesajulâ€¦',
        'Connecting': 'Se conecteazÄƒ',
        'Connection lost': 'Conexiune pierdutÄƒ',
        'Connection re-established': 'Conexiune restabilitÄƒ',
        'Offline': 'Offline',
        'Online': 'Online',
        'Scroll down to see new messages': 'DerulaÈ›i Ã®n jos pentru a vedea mesajele noi',
        'Send': 'Trimite',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Deoarece nu ai rÄƒspuns Ã®n ultimele %s minute, conversaÈ›ia ta a fost Ã®nchisÄƒ.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Deoarece nu ai rÄƒspuns Ã®n ultimele %s minute, conversaÈ›ia ta cu <strong>%s</strong> a fost Ã®nchisÄƒ.',
        'Start new conversation': 'ÃŽncepe o conversaÈ›ie nouÄƒ',
        'Today': 'Azi',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Ne pare rÄƒu, dureazÄƒ mai mult decÃ¢t ne aÈ™teptam sÄƒ obÈ›inem un loc. Te rugÄƒm sÄƒ Ã®ncerci din nou mai tÃ¢rziu sau sÄƒ ne trimiÈ›i un email. MulÈ›umim!',
        'You are on waiting list position <strong>%s</strong>.': 'AveÈ›i poziÈ›ia <strong>%s</strong> Ã®n lista de aÈ™teptare.'
      },
      'ru': {
        '<strong>Chat</strong> with us!': '<strong>ÐÐ°Ð¿Ð¸ÑˆÐ¸Ñ‚Ðµ</strong> Ð½Ð°Ð¼!',
        'All colleagues are busy.': 'Ð’ÑÐµ ÐºÐ¾Ð»Ð»ÐµÐ³Ð¸ Ð·Ð°Ð½ÑÑ‚Ñ‹.',
        'Chat closed by %s': 'Ð§Ð°Ñ‚ Ð·Ð°ÐºÑ€Ñ‹Ñ‚ %s',
        'Compose your messageâ€¦': 'Ð¡Ð¾ÑÑ‚Ð°Ð²ÑŒÑ‚Ðµ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµâ€¦',
        'Connecting': 'ÐŸÐ¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ',
        'Connection lost': 'ÐŸÐ¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ Ð¿Ð¾Ñ‚ÐµÑ€ÑÐ½Ð¾',
        'Connection re-established': 'ÐŸÐ¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ Ð²Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð¾',
        'Offline': 'ÐžÑ„Ñ„Ð»Ð°Ð¹Ð½',
        'Online': 'Ð’ ÑÐµÑ‚Ð¸',
        'Scroll down to see new messages': 'ÐŸÑ€Ð¾ÐºÑ€ÑƒÑ‚Ð¸Ñ‚Ðµ Ð²Ð½Ð¸Ð·, Ñ‡Ñ‚Ð¾Ð±Ñ‹ ÑƒÐ²Ð¸Ð´ÐµÑ‚ÑŒ Ð½Ð¾Ð²Ñ‹Ðµ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ñ',
        'Send': 'ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'ÐŸÐ¾ÑÐºÐ¾Ð»ÑŒÐºÑƒ Ð’Ñ‹ Ð½Ðµ Ð¾Ñ‚Ð²ÐµÑ‚Ð¸Ð»Ð¸ Ð² Ñ‚ÐµÑ‡ÐµÐ½Ð¸Ðµ Ð¿Ð¾ÑÐ»ÐµÐ´Ð½Ð¸Ñ… %s Ð¼Ð¸Ð½ÑƒÑ‚, Ð’Ð°Ñˆ Ñ€Ð°Ð·Ð³Ð¾Ð²Ð¾Ñ€ Ð±Ñ‹Ð» Ð·Ð°ÐºÑ€Ñ‹Ñ‚.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'ÐŸÐ¾ÑÐºÐ¾Ð»ÑŒÐºÑƒ Ð’Ñ‹ Ð½Ðµ Ð¾Ñ‚Ð²ÐµÑ‚Ð¸Ð»Ð¸ Ð² Ñ‚ÐµÑ‡ÐµÐ½Ð¸Ðµ Ð¿Ð¾ÑÐ»ÐµÐ´Ð½Ð¸Ñ… %s Ð¼Ð¸Ð½ÑƒÑ‚, Ð’Ð°Ñˆ Ñ€Ð°Ð·Ð³Ð¾Ð²Ð¾Ñ€ Ñ <strong>%s</strong> Ð±Ñ‹Ð» Ð·Ð°ÐºÑ€Ñ‹Ñ‚.',
        'Start new conversation': 'ÐÐ°Ñ‡Ð°Ñ‚ÑŒ Ð½Ð¾Ð²Ñ‹Ð¹ Ñ€Ð°Ð·Ð³Ð¾Ð²Ð¾Ñ€',
        'Today': 'Ð¡ÐµÐ³Ð¾Ð´Ð½Ñ',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Ð˜Ð·Ð²Ð¸Ð½Ð¸Ñ‚Ðµ, Ð¿Ð¾Ð»ÑƒÑ‡ÐµÐ½Ð¸Ðµ ÑÐ²Ð¾Ð±Ð¾Ð´Ð½Ð¾Ð³Ð¾ ÑÐ»Ð¾Ñ‚Ð° Ð·Ð°Ð½Ð¸Ð¼Ð°ÐµÑ‚ Ð±Ð¾Ð»ÑŒÑˆÐµ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð¸, Ñ‡ÐµÐ¼ Ð¾Ð¶Ð¸Ð´Ð°Ð»Ð¾ÑÑŒ. ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€Ð¸Ñ‚Ðµ Ð¿Ð¾Ð¿Ñ‹Ñ‚ÐºÑƒ Ð¿Ð¾Ð·Ð¶Ðµ Ð¸Ð»Ð¸ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÑŒÑ‚Ðµ Ð½Ð°Ð¼ ÑÐ»ÐµÐºÑ‚Ñ€Ð¾Ð½Ð½Ð¾Ðµ Ð¿Ð¸ÑÑŒÐ¼Ð¾. Ð‘Ð»Ð°Ð³Ð¾Ð´Ð°Ñ€Ð¸Ð¼ Ð’Ð°Ñ!',
        'You are on waiting list position <strong>%s</strong>.': 'Ð’Ñ‹ Ð½Ð°Ñ…Ð¾Ð´Ð¸Ñ‚ÐµÑÑŒ Ð² ÑÐ¿Ð¸ÑÐºÐµ Ð¾Ð¶Ð¸Ð´Ð°Ð½Ð¸Ñ <strong>%s</strong>.'
      },
      'sk': {
        '<strong>Chat</strong> with us!': '<strong>NapÃ­Å¡te</strong> nÃ¡m cez chat!',
        'All colleagues are busy.': 'VÅ¡etci kolegovia sÃº zaneprÃ¡zdnenÃ­.',
        'Chat closed by %s': 'Chat zatvoril(a) %s',
        'Compose your messageâ€¦': 'NapÃ­Å¡te vaÅ¡u sprÃ¡vuâ€¦',
        'Connecting': 'PripÃ¡ja sa',
        'Connection lost': 'Spojenie preruÅ¡enÃ©',
        'Connection re-established': 'Pripojenie obnovenÃ©',
        'Offline': 'Offline',
        'Online': 'Online',
        'Scroll down to see new messages': 'PosuÅˆte sa nadol, aby ste videli novÃ© sprÃ¡vy',
        'Send': 'OdoslaÅ¥',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'KeÄÅ¾e ste neodpovedali v poslednÃ½ch %s minÃºtach, vaÅ¡a konverzÃ¡cia bola uzavretÃ¡.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'KeÄÅ¾e ste v poslednÃ½ch %s minÃºtach neodpovedali, vaÅ¡a konverzÃ¡cia s <strong>%s</strong> bola ukonÄenÃ¡.',
        'Start new conversation': 'ZaÄaÅ¥ novÃº konverzÃ¡ciu',
        'Today': 'Dnes',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Je nÃ¡m Ä¾Ãºto, Å¾e zÃ­skanie slotu trvÃ¡ dlhÅ¡ie, neÅ¾ sme oÄakÃ¡vali. SkÃºste to prosÃ­m neskÃ´r alebo nÃ¡m poÅ¡lite e-mail. ÄŽakujeme!',
        'You are on waiting list position <strong>%s</strong>.': 'Na Äakacej listine ste na pozÃ­cii <strong>%s</strong>.'
      },
      'sr': {
        '<strong>Chat</strong> with us!': '<strong>Ð‹Ð°ÑÐºÐ°Ñ˜Ñ‚Ðµ</strong> ÑÐ° Ð½Ð°Ð¼Ð°!',
        'All colleagues are busy.': 'Ð¡Ð²Ðµ ÐºÐ¾Ð»ÐµÐ³Ðµ ÑÑƒ Ð·Ð°ÑƒÐ·ÐµÑ‚Ðµ.',
        'Chat closed by %s': 'Ð‹Ð°ÑÐºÐ°ÑšÐµ Ð·Ð°Ñ‚Ð²Ð¾Ñ€ÐµÐ½Ð¾ Ð¾Ð´ ÑÑ‚Ñ€Ð°Ð½Ðµ %s',
        'Compose your messageâ€¦': 'ÐÐ°Ð¿Ð¸ÑˆÐ¸Ñ‚Ðµ Ð¿Ð¾Ñ€ÑƒÐºÑƒâ€¦',
        'Connecting': 'ÐŸÐ¾Ð²ÐµÐ·Ð¸Ð²Ð°ÑšÐµ',
        'Connection lost': 'Ð’ÐµÐ·Ð° Ñ˜Ðµ Ð¸Ð·Ð³ÑƒÐ±Ñ™ÐµÐ½Ð°',
        'Connection re-established': 'Ð’ÐµÐ·Ð° Ñ˜Ðµ Ð¿Ð¾Ð½Ð¾Ð²Ð¾ ÑƒÑÐ¿Ð¾ÑÑ‚Ð°Ð²Ñ™ÐµÐ½Ð°',
        'Offline': 'ÐžÐ´ÑÑƒÑ‚Ð°Ð½(Ð°)',
        'Online': 'Ð”Ð¾ÑÑ‚ÑƒÐ¿Ð°Ð½(Ð°)',
        'Scroll down to see new messages': 'Ð¡ÐºÑ€Ð¾Ð»ÑƒÑ˜Ñ‚Ðµ Ð½Ð° Ð´Ð¾Ð»Ðµ Ð·Ð° Ð½Ð¾Ð²Ðµ Ð¿Ð¾Ñ€ÑƒÐºÐµ',
        'Send': 'ÐŸÐ¾ÑˆÐ°Ñ™Ð¸',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'ÐŸÐ¾ÑˆÑ‚Ð¾ Ð½Ð¸ÑÑ‚Ðµ Ð¾Ð´Ð³Ð¾Ð²Ð¾Ñ€Ð¸Ð»Ð¸ Ñƒ Ð¿Ð¾ÑÐ»ÐµÐ´ÑšÐ¸Ñ… %s Ð¼Ð¸Ð½ÑƒÑ‚(a), Ð²Ð°Ñˆ Ñ€Ð°Ð·Ð³Ð¾Ð²Ð¾Ñ€ Ñ˜Ðµ Ð·Ð°Ð²Ñ€ÑˆÐµÐ½.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'ÐŸÐ¾ÑˆÑ‚Ð¾ Ð½Ð¸ÑÑ‚Ðµ Ð¾Ð´Ð³Ð¾Ð²Ð¾Ñ€Ð¸Ð»Ð¸ Ñƒ Ð¿Ð¾ÑÐ»ÐµÐ´ÑšÐ¸Ñ… %s Ð¼Ð¸Ð½ÑƒÑ‚(a), Ð²Ð°Ñˆ Ñ€Ð°Ð·Ð³Ð¾Ð²Ð¾Ñ€ ÑÐ° <strong>%s</strong> Ñ˜Ðµ Ð·Ð°Ð²Ñ€ÑˆÐµÐ½.',
        'Start new conversation': 'Ð—Ð°Ð¿Ð¾Ñ‡Ð½Ð¸ Ð½Ð¾Ð²Ð¸ Ñ€Ð°Ð·Ð³Ð¾Ð²Ð¾Ñ€',
        'Today': 'Ð”Ð°Ð½Ð°Ñ',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Ð–Ð°Ð¾ Ð½Ð°Ð¼ Ñ˜Ðµ, Ð´Ð¾Ð±Ð¸Ñ˜Ð°ÑšÐµ Ð¿Ñ€Ð°Ð·Ð½Ð¾Ð³ Ñ‚ÐµÑ€Ð¼Ð¸Ð½Ð° Ñ‚Ñ€Ð°Ñ˜Ðµ Ð´ÑƒÐ¶Ðµ Ð¾Ð´ Ð¾Ñ‡ÐµÐºÐ¸Ð²Ð°Ð½Ð¾Ð³. ÐœÐ¾Ð»Ð¸Ð¼Ð¾ Ð¿Ð¾ÐºÑƒÑˆÐ°Ñ˜Ñ‚Ðµ Ð¿Ð¾Ð½Ð¾Ð²Ð¾ ÐºÐ°ÑÐ½Ð¸Ñ˜Ðµ Ð¸Ð»Ð¸ Ð½Ð°Ð¼ Ð¿Ð¾ÑˆÐ°Ñ™Ð¸Ñ‚Ðµ Ð¸Ð¼ÐµÑ˜Ð» Ð¿Ð¾Ñ€ÑƒÐºÑƒ. Ð¥Ð²Ð°Ð»Ð° Ð²Ð°Ð¼!',
        'You are on waiting list position <strong>%s</strong>.': 'Ð’Ð¸ ÑÑ‚Ðµ Ñ‚Ñ€ÐµÐ½ÑƒÑ‚Ð½Ð¾ <strong>%s.</strong> Ñƒ Ñ€ÐµÐ´Ñƒ Ð·Ð° Ñ‡ÐµÐºÐ°ÑšÐµ.'
      },
      'sr-latn-rs': {
        '<strong>Chat</strong> with us!': '<strong>Ä†askajte</strong> sa nama!',
        'All colleagues are busy.': 'Sve kolege su zauzete.',
        'Chat closed by %s': 'Ä†askanje zatvoreno od strane %s',
        'Compose your messageâ€¦': 'NapiÅ¡ite porukuâ€¦',
        'Connecting': 'Povezivanje',
        ...
        'Send': 'PoÅ¡alji',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'PoÅ¡to niste odgovorili u poslednjih %s minut(a), vaÅ¡ razgovor je zavrÅ¡en.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'PoÅ¡to niste odgovorili u poslednjih %s minut(a), vaÅ¡ razgovor sa <strong>%s</strong> je zavrÅ¡en.',
        'Start new conversation': 'ZapoÄni novi razgovor',
        'Today': 'Danas',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Å½ao nam je, dobijanje praznog termina traje duÅ¾e od oÄekivanog. Molimo pokuÅ¡ajte ponovo kasnije ili nam poÅ¡aljite imejl poruku. Hvala vam!',
        'You are on waiting list position <strong>%s</strong>.': 'Vi ste trenutno <strong>%s.</strong> u redu za Äekanje.'
      },
      'sv': {
        '<strong>Chat</strong> with us!': '<strong>Chatta</strong> med oss!',
        'All colleagues are busy.': 'Alla kollegor Ã¤r upptagna.',
        'Chat closed by %s': 'Chatt stÃ¤ngd av %s',
        'Compose your messageâ€¦': 'Skriv ditt meddelande â€¦',
        'Connecting': 'Ansluter',
        'Connection lost': 'Anslutningen fÃ¶rsvann',
        'Connection re-established': 'Anslutningen Ã¥terupprÃ¤ttas',
        'Offline': 'Offline',
        'Online': 'Online',
        'Scroll down to see new messages': 'BlÃ¤ddra ner fÃ¶r att se nya meddelanden',
        'Send': 'Skicka',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Din chatt avslutades dÃ¥ du inte svarade inom %s minuter.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Chatten stÃ¤ngdes eftersom du inte svarat inom %s minuter i din konversation med <strong>%s</strong>.',
        'Start new conversation': 'Starta ny konversation',
        'Today': 'Idag',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'Det tar tyvÃ¤rr lÃ¤ngre tid Ã¤n fÃ¶rvÃ¤ntat att fÃ¥ en ledig plats. FÃ¶rsÃ¶k igen senare eller skicka ett mejl till oss. Tack!',
        'You are on waiting list position <strong>%s</strong>.': 'Du Ã¤r pÃ¥ vÃ¤ntelistan som position <strong>%s</strong>.'
      },
      'tr': {
        '<strong>Chat</strong> with us!': 'Bizimle <strong>Sohbet</strong> edin!',
        'All colleagues are busy.': 'TÃ¼m meslektaÅŸlar meÅŸgul.',
        'Chat closed by %s': 'Sohbet %s tarafÄ±ndan kapatÄ±ldÄ±',
        'Compose your messageâ€¦': 'MesajÄ±nÄ±zÄ± yazÄ±nâ€¦',
        'Connecting': 'BaÄŸlanÄ±yor',
        'Connection lost': 'BaÄŸlantÄ± koptu',
        'Connection re-established': 'BaÄŸlantÄ± yeniden saÄŸlandÄ±',
        'Offline': '',
        'Online': 'Online',
        'Scroll down to see new messages': 'Scroll down to see new messages',
        'Send': 'GÃ¶nder',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': 'Son %s dakika iÃ§inde yanÄ±t vermediÄŸiniz iÃ§in gÃ¶rÃ¼ÅŸmeniz kapatÄ±ldÄ±.',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Son %s dakika iÃ§inde yanÄ±t vermediÄŸiniz iÃ§in <strong>%s</strong> ile gÃ¶rÃ¼ÅŸmeniz kapatÄ±ldÄ±.',
        'Start new conversation': '',
        'Today': 'BugÃ¼n',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': 'ÃœzgÃ¼nÃ¼z, yer bulmamÄ±z beklenenden daha uzun sÃ¼rÃ¼yor. LÃ¼tfen daha sonra tekrar deneyin veya bize bir e-posta gÃ¶nderin. TeÅŸekkÃ¼r ederiz!',
        'You are on waiting list position <strong>%s</strong>.': 'Bekleme listesinde <strong>%s</strong> konumundasÄ±nÄ±z.'
      },
      'zh-cn': {
        '<strong>Chat</strong> with us!': 'å‘èµ·<strong>å³æ—¶å¯¹è¯</strong>!',
        'All colleagues are busy.': 'æ‰€æœ‰åŒäº‹éƒ½å¾ˆå¿™ã€‚',
        'Chat closed by %s': 'å¯¹è¯å·²è¢« %s å…³é—­',
        'Compose your messageâ€¦': 'ç¼–è¾‘æ‚¨çš„ä¿¡æ¯â€¦',
        'Connecting': 'è¿žæŽ¥ä¸­',
        'Connection lost': 'è¿žæŽ¥ä¸¢å¤±',
        'Connection re-established': 'æ­£åœ¨é‡æ–°å»ºç«‹è¿žæŽ¥',
        'Offline': 'ç¦»çº¿',
        'Online': 'åœ¨çº¿',
        'Scroll down to see new messages': 'å‘ä¸‹æ»šåŠ¨ä»¥æŸ¥çœ‹æ–°æ¶ˆæ¯',
        'Send': 'å‘é€',
        'Since you didn\'t respond in the last %s minutes your conversation was closed.': '"ç”±äºŽæ‚¨è¶…è¿‡ %s åˆ†é’Ÿæ²¡æœ‰ä»»ä½•å›žå¤',
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': '"ç”±äºŽæ‚¨è¶…è¿‡ %s åˆ†é’Ÿæ²¡æœ‰å›žå¤',
        'Start new conversation': 'å¼€å§‹æ–°çš„ä¼šè¯',
        'Today': 'ä»Šå¤©',
        'We are sorry, it is taking longer than expected to get a slot. Please try again later or send us an email. Thank you!': '',
        'You are on waiting list position <strong>%s</strong>.': 'æ‚¨ç›®å‰çš„ç­‰å€™ä½ç½®æ˜¯ç¬¬ <strong>%s</strong> ä½.'
      }
    };
    ...
    ZammadChat.prototype.onSessionClosed = function(data) {
      var base;
      this.addStatus(this.T('Chat encerrado por %s', data.realname));
      this.disableInput();
      this.setAgentOnlineState('offline');
      this.inactiveTimeout.stop();
